"""
Automated Pytest for ecg-axis-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    Continuous12leadEcgWaveformStreamingWithAxisDeviationTrackingEngine,
    ...
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    EcgaxiscalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = EcgaxiscalculatorEnrichmentSuite()
